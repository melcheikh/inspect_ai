...
class Score(BaseModel):
    ...
    # Non-finite floats (the NaN unscored sentinel) serialize as JSON constants
    # rather than null. Pydantic reads this setting from the dump-root model only,
    # so every score-bearing wire root repeats it (see design/nan-serialization.md).
    model_config = ConfigDict(ser_json_inf_nan="constants")
